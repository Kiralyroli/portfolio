...
export const ui = {
  hu: {
    ...
    'contact.form.privacy': 'Elolvastam és elfogadom az',
    'contact.form.privacyLink': 'adatkezelési tájékoztatót',
    'privacy.title': 'Adatkezelési tájékoztató',
    'privacy.path': '/adatkezeles/',
    'nav.home': 'Vissza a főoldalra',
    ...
    'meta.title': 'Király Roland — Full Stack fejlesztő | PHP, Symfony, OpenCart',
    'meta.description': 'Király Roland full stack fejlesztő és programozó Szegedről: webshopok, ERP- és API-integrációk PHP, Symfony, React és Node.js alapon.',
  ...
  en: {
    ...
    'contact.form.privacyLink': 'privacy notice',
    'privacy.title': 'Privacy notice',
    'privacy.path': '/en/privacy/',
    'nav.home': 'Back to the homepage',
    ...
    'meta.title': 'Király Roland — Full Stack Developer | PHP, Symfony, OpenCart',
    'meta.description': 'Király Roland, full stack developer and programmer based in Szeged. Webshops, ERP and API integrations on PHP and Symfony, plus React, Node.js and TypeScript.',
